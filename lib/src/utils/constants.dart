...
///Book type
const PURCHASED_BOOK = 'purchased';
const SAMPLE_BOOK = 'sample';

const ALL_BOOK = "ALL BOOKS";
...
///payment status
const PAYMENT_STATUS_SUCCESS = "TXN_SUCCESS";
const PAYMENT_STATUS_FAILED = "TXN_FAILED";
